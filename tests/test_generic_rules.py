...
"""Tests for AbstractRules (add, add_path, validate, backward compatibility)."""
...
class TestAbstractRulesAdd(unittest.TestCase):
    """Tests for AbstractRules.add method."""

    def test_add_single_rule(self):
        """Adding a single rule creates one group."""
        rules = AbstractRules(backend=PrometheusRuleBackend())
    ...
    def test_add_with_topology(self):
        ...
        topo = make_topology()
        rules = AbstractRules(backend=PrometheusRuleBackend(topology=topo))
    ...
    def test_topology_set_on_backend(self):
        """Topology passed to the backend is available on AbstractRules.backend."""
        topo = make_topology()
...
# ===================================================================
# AbstractRules – add_path
# ===================================================================


class TestAbstractRulesAddPath(unittest.TestCase):
    """Tests for AbstractRules.add_path with file and directory loading."""
    ...
    def test_add_path_single_file(self):
        ...
        rules = AbstractRules(backend=PrometheusRuleBackend(topology=self.topology))
...
# ===================================================================
# AbstractRules – produces same output as legacy Rules
# ===================================================================


class TestAbstractRulesBackwardCompat(unittest.TestCase):
    """Verify AbstractRules with PrometheusRuleBackend matches legacy Rules output."""

    def setUp(self):
        self.topology = make_topology()

    def test_add_produces_same_as_legacy(self):
        """AbstractRules.add with group_name produces same structure as legacy Rules._from_dict."""
        ...
        generic = AbstractRules(backend=PrometheusRuleBackend())
